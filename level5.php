		...
		<div class="w3-main" style="margin-left: 250px">
			<div class="w3-row w3-padding-64">
				<div class="w3-twothird w3-container">
					<h1 class="w3-text-teal">Level 5</h1>
					<br />
					<h4>
            Content Security Policy : script-src 'unsafe-eval' https://cdnjs.cloudflare.com/ ; object-src 'none' ; report-uri /reportURL;
          </h4>
					<br />
					<br />
				...
				<div id="hintDesc">Some libs can trigger the alert.</div>
			</div>
		</body>
	</html>
