...
header("Content-Security-Policy: default-src 'self'; script-src 'self' http://yourjavascript.com/")
		...
		<div class="w3-main" style="margin-left: 250px">
			<div class="w3-row w3-padding-64">
				<div class="w3-twothird w3-container">
					<h1 class="w3-text-teal">Level 2</h1>
					<br />
					<h4>
            Content Security Policy : default-src 'self'; script-src 'self' http://yourjavascript.com/
          </h4>
					<br />
					<br />
					<?php
...
?>
				...
				<div id="hintDesc">Uploading refers to transmitting data from one computer system to another through means of a network.</div>
			</div>
		</body>
	</html>
