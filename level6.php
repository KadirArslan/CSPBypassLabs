...
header("Content-Security-Policy: script-src 'self' https://www.googleapis.com ; object-src 'none' ;  ");
		...
		<div class="w3-main" style="margin-left: 250px">
			<div class="w3-row w3-padding-64">
				<div class="w3-twothird w3-container">
					<h1 class="w3-text-teal">Level 6</h1>
					<br />
					<h4>
            Content Security Policy : script-src 'self' https://www.googleapis.com ; object-src 'none' ;
          </h4>
					<br />
					<br />
